...
public class CustomerTest {
	...
	Customer newCustomer = (new Customer(1L,"Rajat verma","Street 344","Delhi","India","rajat@gmail.com","GHDSG56","9384739233",date,"male","Savings"));
	...
	public void Test_toString(){
		assertEquals("Customer(custId=0, name=null, address=null, state=null, country=null, email=null, pan=null, contact=null, dob=null, gender=null, accountType=null)",cust.toString());
	}
//	@Test
//	public void Test_Equals_Success() {
//		assertEquals(oldCustomer,newCustomer);
//	}
//	@Test
//	public void Test_HashCode_Success() {
//		assertEquals(oldCustomer.hashCode(),newCustomer.hashCode());
//	}
//	
//	@Test
//	public void Test_Equals_Fail() {
//		newCustomer.setAccountType("Salary");
//		assertNotEquals(oldCustomer,newCustomer);
//	}
//	@Test
//	public void Test_HashCode_Fail() {
//		newCustomer.setAccountType("Salary");
//		assertNotEquals(oldCustomer.hashCode(),newCustomer.hashCode());
//	}
//	
}
